...
class TransactionService extends Service {
  async getTransaction(id) {
    ...
    const {Address: RawAddress} = this.app.kalycoininfo.lib
  ...
  async getRawTransaction(id) {
    ...
    const {Transaction: RawTransaction, Input, Output, OutputScript} = this.app.kalycoininfo.lib
  ...
  async sendRawTransaction(data) {
    let client = new this.app.kalycoininfo.rpc(this.app.config.kalycoininfo.rpc)
  ...
  transformInput(input, index, transaction, {brief}) {
    const {InputScript, OutputScript} = this.app.kalycoininfo.lib
  ...
  transformOutput(output, index, {brief}) {
    const {OutputScript} = this.app.kalycoininfo.lib
  ...
  async getContractTransaction(receiptId) {
    const {Address: RawAddress, OutputScript} = this.app.kalycoininfo.lib
    const {
